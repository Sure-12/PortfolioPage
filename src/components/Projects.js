          ...
          {project.map((data) => (
            ...
            <div key={data.id} className='my-4 col-sm-6 col-md-4 col-lg-3 mx-4'>
              ...
              >
                ...
                <img src={data.imageSrc} className="card-img-top d-flex justify-content-center align-content-center p-3" alt="..." style={{width:'250px', height:'200px', border:'2px solid yellow', borderRadius:'10px', margin:'19px'}}/>
                </div>
